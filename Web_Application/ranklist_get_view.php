...
foreach ($all_ranklist as $key => $value) {
    ...
    $ranklist_user_link = '<a href="profile.php?user=' . $ranklist_username . '">' . $ranklist_username . '</a>';
    ...
    foreach ($countries_ar as $key => $value) {
        if ($key == $single_user_country) {
            ...
            $single_user_country_full = '<img src="css/flags/blank.gif" class="flag flag-' . $selected_val . '" /> ' . $single_user_country_full;
            break;
        }
    }
    ...
    $ret_str = $ret_str . "<td>" . $user_rank . "</td>";
    $ret_str = $ret_str . "<td>" . $single_user_photo_img . "</td>";

    $ret_str = $ret_str . "<td>" . $ranklist_user_link . "</td>";
    $ret_str = $ret_str . "<td>" . $single_user_country_full . "</td>";
    $ret_str = $ret_str . "<td>" . $number_of_ac . "</td>";
